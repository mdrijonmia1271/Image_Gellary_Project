...
<body>
    <div class="container" >
        <div class="row">
            ...
            <?php if(isset($_POST['submit'])){echo $password;}?>
                <form action="user.php" method="POST">
                    ...
                    <h1 style="text-align:center;">Create Account</h1>
                        ...
                        <?php if(isset($_POST['submit'])){echo "<span class ='text-danger'>".$emptSmg_firstName."</span>";} ?>
                    </div>
                    <div class="mt-2">
                        ...
                        <?php if(isset($_POST['submit'])){echo "<span class ='text-danger'>".$emptSmg_lastName."</span>";} ?>
                    </div>
                    <div class="mt-2">
                    ...
                    <div class="mt-2">
                        ...
                        <?php if(isset($_POST['submit'])){echo "<span class ='text-danger'>".$emptSmg_passwordAgain."</span>";} ?>
                    </div>
                    <div class="mt-4">
